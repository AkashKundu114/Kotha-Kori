...
**Files:** `docs/TRD.md` §7.1 and `docs/PRD.md` §6 both state audio is deleted within 60 seconds of transcription. No file in the v2 codebase does this — audio bytes are downloaded and passed in-memory but there's no explicit S3 lifecycle rule or deletion call anywhere.
