# Original v1 Product Specs (carried over, still valid)

The files referenced here (PRD.md, TRD.md, ROADMAP.md, APP_FLOW.md,
IMPLEMENTATION_PLAN.md) describe the *product* — personas, feature specs,
