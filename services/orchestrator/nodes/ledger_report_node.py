...
async def ledger_report_node(state: ConversationState) -> dict:
    ...
    if not user_id:
        return {
            "outbound_messages": [
                {"type": "text", "body": "আগে হিসাব শুরু করুন, তারপর রিপোর্ট পাবেন।"}
            ],
    ...
    try:
        ...
        return {
            "outbound_messages": [
                {
                    "type": "text",
                    "body": "রিপোর্ট তৈরি করতে সমস্যা হয়েছে। একটু পরে আবার চেষ্টা করুন।",
                }
            ],
    ...
    if result["total_income"] == 0 and result["total_expense"] == 0:
        return {
            "outbound_messages": [
                {
                    "type": "text",
                    "body": f"{BENGALI_MONTHS[today.month]} মাসে কোনো হিসাব পাওয়া যায়নি।",
                }
            ],
